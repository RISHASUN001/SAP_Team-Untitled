...
How would you like to get started today?`,
  ...
  const generateAIResponse = async (userMessage: string, mode: string): Promise<Message> => {
    ...
    if (mode === 'mentor') {
      response = `Based on your message, here are some mentoring suggestions:

**Tone Recommendation**: Use a supportive yet directive approach. This helps build confidence while providing clear guidance.

**Key Points to Address**:
• Acknowledge their effort and current progress
• Break down complex problems into manageable steps
• Encourage questions and create a safe learning environment

**Suggested Response Approach**: "I appreciate you bringing this challenge to me. Let's work through this together step by step..."`;

      suggestions = [
        "Ask clarifying questions to understand their specific struggle",
        "Share a similar experience from your own learning journey",
        "Suggest practical next steps they can take immediately",
        "Schedule a follow-up to check on their progress"
      ];
